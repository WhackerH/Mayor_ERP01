	...
	lua_thread.create(function()
		if #pam ~= 0 then
			if pam == 'forum' then
				...
				wait(5000)
				sampSendChat('/gov [City Hall]: На оф. портале штата открыты заявления на должность Заместителя Мэра.')
				wait(5000)
				sampSendChat('/gov [City Hall]: Подробную информацию вы можете найти на оф. портале мэрии.')
			elseif pam == 'forum1' then
				sampSendChat('/gov [City Hall]: Добрый день, уважаемые жители и гости штата, минуточку внимания!')
				wait(5000)
				sampSendChat('/gov [City Hall]: На оф. портале мэрии штата вновь открыты заявления на должность секретарь/охранник.')
				wait(5000)
				sampSendChat('/gov [City Hall]: Критерии вы можете найти на оф. портале. Ждём вас! ')
			elseif pam == 'chs' then
				sampSendChat('/gov [City Hall]: Добрый день, уважаемые жители и гости штата, минуточку внимания! ')
				wait(5000)
				sampSendChat('/gov [City Hall]: Уведомляю вас о том, что была проведена амнистия ЧС Мэрии, это значит, что: Все, кто попадали... ')
				wait(5000)
				sampSendChat('/gov [City Hall]: ...ЧС по каким-либо нарушениям убраны оттуда и получают второй шанс на развитие в мэрии! ')
			elseif pam == 'nabor' then
				...
				wait(5000)
				sampSendChat('/gov [City Hall]: Критерии: Прописка от 8-ми лет в штате, опрятный вид, комлпект лицензий. Ждём вас! ')
			elseif pam == 'pensii' then
				sampSendChat('/gov [City Hall]: Добрый день, уважаемые жители и гости штата, минуточку внимания! ')
				wait(5000)
				sampSendChat('/gov [City Hall]: Уведомляю вас о том, что на оф. портале Мэрии снова начала действовать выплата пенсий. ')
				wait(5000)
				sampSendChat('/gov [City Hall]: Для получения пенсии необходимо: проживать в штате от 27-ми лет и оставить заявление. Ждём вас! ')
			end
		end
	end)
end
